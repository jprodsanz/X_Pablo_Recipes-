...
class Recipe:
    ...
    def get_by_id(cls, recipe_id):
        ...
        query = """SELECT recipes.id, recipes.created_at, recipes.updated_at, instructions, description, name, date_made, under_30,
                    registrants.id as registrant_id, first_name, last_name, email, registrants.created_at as uc, registrants.updated_at as uu
                    FROM recipes
                    JOIN registrants on registrants.id = recipes.registrant_id
